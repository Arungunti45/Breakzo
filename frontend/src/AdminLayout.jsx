...
import { LayoutDashboard, ChefHat, LogOut, Bell, Search, Settings, Menu as MenuIcon, X, ClipboardList, Wallet, Leaf, Sun, Moon, Tag, MessageSquare } from 'lucide-react';
...
function AdminLayout() {
  ...
  const navItems = [
    ...
    { name: 'Offers Management', path: '/admin/offers', icon: <Tag size={20} /> },
    { name: 'Student Feedback', path: '/admin/reviews', icon: <MessageSquare size={20} /> },
    { name: 'Sustainability', path: '/admin/sustainability', icon: <Leaf size={20} /> },
  ];
      ...
      <aside className={`absolute md:relative z-50 w-64 h-full bg-slate-900 text-slate-300 flex flex-col shadow-2xl transition-transform duration-300 ease-in-out ${
        ...
        <div className="h-16 flex items-center justify-between px-6 bg-slate-950 border-b border-slate-800">
          <div className="flex items-center">
            <img src="/breakzo.png" alt="Breakzo Logo" className="h-12 w-auto mr-3 border-[5px] border-slate-900 rounded-[2rem] p-1 bg-white drop-shadow-sm" />
